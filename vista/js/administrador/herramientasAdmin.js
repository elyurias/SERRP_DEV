...
function qrData(id){
    ...
    $('#msgData').html("<div id='modal1' class='modal modal-fixed-footer'><div class='modal-content'><h5><center>Mensaje del Sistema: Generacion de c√≥digo QR</center></h5><p><center><div id='qr'></div><h6>El siguiente c√≥digo QR permite el acceso al sistema de entrega y revisi√≥n de residencias profesionales al usuario con el ID: "+id+" </h6></center></p></div><div class='modal-footer'><a href='#' class='modal-action modal-close waves-effect waves-green btn-flat'>OK</a></div></div>");
	$('#modal1').modal();
	$('#qr').qrcode({
...
console.log('Por defecto, todos los registros est·n deshabilitados o escritos en archivos. El registro general de consultas y el registro lento de consultas tambiÈn se pueden escribir en tablas especiales en la base de datos mysql.');
