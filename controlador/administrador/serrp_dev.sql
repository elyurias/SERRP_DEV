...
INSERT INTO `cgeneracion` VALUES (1,'2017-1','2017-05-01','2017-05-01',0),(2,'2017-2','2017-09-01','2018-01-26',0),(3,'2016-2','2016-07-01','2016-08-01',0),(5,'2018-1','2018-01-01','2018-01-13',1);
...
--
-- Temporary table structure for view `get_generacion_all_data`
--

DROP TABLE IF EXISTS `get_generacion_all_data`;
/*!50001 DROP VIEW IF EXISTS `get_generacion_all_data`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `get_generacion_all_data` (
...
--
-- Temporary table structure for view `getalumnos_docente_periodo`
--

DROP TABLE IF EXISTS `getalumnos_docente_periodo`;
/*!50001 DROP VIEW IF EXISTS `getalumnos_docente_periodo`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `getalumnos_docente_periodo` (
  `id_asesor` tinyint NOT NULL,
  `id_alumno` tinyint NOT NULL,
  `VidentiQR_usuario` tinyint NOT NULL,
  `Vnombre_usuario` tinyint NOT NULL,
...
--
-- Temporary table structure for view `getsolicitudesasesor`
--

DROP TABLE IF EXISTS `getsolicitudesasesor`;
/*!50001 DROP VIEW IF EXISTS `getsolicitudesasesor`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `getsolicitudesasesor` (
  `id_asesor` tinyint NOT NULL,
  `id_pa` tinyint NOT NULL,
  `Iestado_pa` tinyint NOT NULL,
  `Dregistro_pa` tinyint NOT NULL,
...
--
-- Temporary table structure for view `ver_todos_los_usuarios`
--

DROP TABLE IF EXISTS `ver_todos_los_usuarios`;
/*!50001 DROP VIEW IF EXISTS `ver_todos_los_usuarios`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `ver_todos_los_usuarios` (
  `VidentiQR_usuario` tinyint NOT NULL,
  `Vnombre_usuario` tinyint NOT NULL,
  `Vpaterno_usuario` tinyint NOT NULL,
  `Vmaterno_usuario` tinyint NOT NULL,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `add_upd_periodo_actual_asesor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `add_upd_periodo_actual_asesor`(FAccion INT, FVidentiM VARCHAR(255), Fid_asesor INT, Flimite INT) RETURNS int(11)
...
BEGIN
DECLARE id_asesorD INT;
	CASE FAccion
		WHEN 1 THEN
			IF(SELECT id_asesor FROM asesor_data
				WHERE id_cg = get_periodo_actual_id()
                AND id_usuario = FVidentiM) THEN
			RETURN 2;
            ELSE
            INSERT INTO asesor_data(`id_asesor`,`id_usuario`,`Ilimite_asesor`,`id_cg`)
				VALUES
				(
					0,
					FVidentiM,
					Flimite,
					get_periodo_actual_id()
                 );
					RETURN 3;
                    END IF;
				WHEN 2 THEN
					UPDATE asesor_data
						SET Ilimite_asesor = Flimite WHERE id_asesor = Fid_asesor;
					RETURN 4;
			END CASE;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `alumno_periodo_actual` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `alumno_periodo_actual`(id_usuarioF varchar(255)) RETURNS int(11)
    COMMENT '\n	Si no esta registrado en el periodo actual retorna 0\n    Si esta registrado registrado en el periodo actual retorna 1\n'
BEGIN
	IF(
		SELECT id_alumno FROM alumno_data WHERE id_usuario = id_usuarioF AND id_cg = get_periodo_actual_id()
    ) IS NULL THEN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `docente_periodo_actual` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `docente_periodo_actual`(id_docente varchar(255)) RETURNS int(11)
BEGIN
	IF(
		SELECT id_asesor FROM asesor_data WHERE id_usuario = id_docente AND id_cg = get_periodo_actual_id()
    ) IS NULL THEN
		RETURN 0;
    ELSE
		RETURN 1;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_limite_asesor_periodo_actual` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_limite_asesor_periodo_actual`(Fid_asesor INT) RETURNS int(11)
BEGIN
	DECLARE limite_asesor INT;
	SELECT ad.Ilimite_asesor INTO limite_asesor
		FROM asesor_data ad
			WHERE 
				ad.id_asesor = Fid_asesor;
	return limite_asesor;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `reg_alumno_periodo_actual_existente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `reg_alumno_periodo_actual_existente`(VidentiQR VARCHAR(255)) RETURNS int(11)
BEGIN
	IF(alumno_periodo_actual(VidentiQR)) = 1 THEN
		RETURN 1;
    ELSE
		INSERT INTO alumno_data VALUES(
			0,
            VidentiQR,
            get_periodo_actual_id()
        );
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `add_new_generacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_new_generacion`(PNombre_cg VARCHAR(20),PFinicio DATE, PFfin DATE)
    COMMENT 'Se actualiza la nueva generacion en el periodo, cambiamos el periodo actual a cero y etc etc...'
BEGIN
	DECLARE id_cg_data INT;
    IF(SELECT id_cg FROM cgeneracion WHERE Vnombre_cg = PNombre_cg) IS NULL THEN
		SELECT get_periodo_actual_id() INTO id_cg_data;
		UPDATE cgeneracion SET Iestado_cg = 0 WHERE id_cg = id_cg_data;
		INSERT INTO cgeneracion VALUES(
			0,
			PNombre_cg,
			PFinicio,
			PFfin,
...
--
-- Final view structure for view `get_generacion_all_data`
--

/*!50001 DROP TABLE IF EXISTS `get_generacion_all_data`*/;
/*!50001 DROP VIEW IF EXISTS `get_generacion_all_data`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `get_generacion_all_data` AS select `cgeneracion`.`id_cg` AS `id_cg`,`cgeneracion`.`Vnombre_cg` AS `Vnombre_cg`,`cgeneracion`.`Dfecha_inicio` AS `Dfecha_inicio`,`cgeneracion`.`Dfecha_fin` AS `Dfecha_fin`,`cgeneracion`.`Iestado_cg` AS `Iestado_cg` from `cgeneracion` order by `cgeneracion`.`Vnombre_cg` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `getalumnos_docente_periodo`
--

/*!50001 DROP TABLE IF EXISTS `getalumnos_docente_periodo`*/;
/*!50001 DROP VIEW IF EXISTS `getalumnos_docente_periodo`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `getalumnos_docente_periodo` AS select `ad`.`id_asesor` AS `id_asesor`,`ald`.`id_alumno` AS `id_alumno`,`u`.`VidentiQR_usuario` AS `VidentiQR_usuario`,`u`.`Vnombre_usuario` AS `Vnombre_usuario`,`u`.`Vpaterno_usuario` AS `Vpaterno_usuario`,`u`.`Vmaterno_usuario` AS `Vmaterno_usuario`,`u`.`Vcorreo_usuario` AS `Vcorreo_usuario`,`u`.`VtelefonoC_usuario` AS `VtelefonoC_usuario`,`u`.`VtelefonoH_usuario` AS `VtelefonoH_usuario`,`u`.`Iestado_usuario` AS `Iestado_usuario`,`u`.`Itipo_usuario` AS `Itipo_usuario`,`u`.`id_especialidad` AS `id_especialidad`,`u`.`Csexo_usuario` AS `Csexo_usuario` from (((`asesor_alumno` `aa` join `asesor_data` `ad` on((`aa`.`id_asesor` = `ad`.`id_asesor`))) join `alumno_data` `ald` on((`aa`.`id_alumno` = `ald`.`id_alumno`))) join `usuario` `u` on((`u`.`VidentiQR_usuario` = `ald`.`id_usuario`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `getsolicitudesasesor`
--

/*!50001 DROP TABLE IF EXISTS `getsolicitudesasesor`*/;
/*!50001 DROP VIEW IF EXISTS `getsolicitudesasesor`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `getsolicitudesasesor` AS select `aa`.`id_asesor` AS `id_asesor`,`aa`.`id_pa` AS `id_pa`,`aa`.`Iestado_pa` AS `Iestado_pa`,`aa`.`Dregistro_pa` AS `Dregistro_pa`,`aa`.`Dinicio_pa` AS `Dinicio_pa`,`aa`.`Dfin_pa` AS `Dfin_pa`,`aa`.`Iprogreso_pa` AS `Iprogreso_pa`,`aa`.`Irestriccion_pa` AS `Irestriccion_pa`,`aa`.`id_alumno` AS `id_alumno`,`ad`.`id_usuario` AS `id_usuario`,`ad`.`Ilimite_asesor` AS `Ilimite_asesor`,`ad`.`id_cg` AS `id_cg`,`u`.`VidentiQR_usuario` AS `VidentiQR_usuario`,`u`.`Vnombre_usuario` AS `Vnombre_usuario`,`u`.`Vpaterno_usuario` AS `Vpaterno_usuario`,`u`.`Vmaterno_usuario` AS `Vmaterno_usuario`,`u`.`Vcorreo_usuario` AS `Vcorreo_usuario`,`u`.`VtelefonoC_usuario` AS `VtelefonoC_usuario`,`u`.`VtelefonoH_usuario` AS `VtelefonoH_usuario`,`u`.`Iestado_usuario` AS `Iestado_usuario`,`u`.`Itipo_usuario` AS `Itipo_usuario`,`u`.`id_especialidad` AS `id_especialidad`,`u`.`Csexo_usuario` AS `Csexo_usuario` from ((`asesor_alumno` `aa` join `asesor_data` `ad` on((`aa`.`id_asesor` = `ad`.`id_asesor`))) join `usuario` `u` on((`u`.`VidentiQR_usuario` = `ad`.`id_usuario`))) where ((`ad`.`id_cg` = `GET_PERIODO_ACTUAL_ID`()) and (`aa`.`Iestado_pa` = 0)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `ver_todos_los_usuarios`
--

/*!50001 DROP TABLE IF EXISTS `ver_todos_los_usuarios`*/;
/*!50001 DROP VIEW IF EXISTS `ver_todos_los_usuarios`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ver_todos_los_usuarios` AS select `usuario`.`VidentiQR_usuario` AS `VidentiQR_usuario`,`usuario`.`Vnombre_usuario` AS `Vnombre_usuario`,`usuario`.`Vpaterno_usuario` AS `Vpaterno_usuario`,`usuario`.`Vmaterno_usuario` AS `Vmaterno_usuario`,`usuario`.`Vcorreo_usuario` AS `Vcorreo_usuario`,`usuario`.`VtelefonoC_usuario` AS `VtelefonoC_usuario`,`usuario`.`VtelefonoH_usuario` AS `VtelefonoH_usuario`,`usuario`.`Iestado_usuario` AS `Iestado_usuario`,`usuario`.`Itipo_usuario` AS `Itipo_usuario`,`usuario`.`id_especialidad` AS `id_especialidad`,`usuario`.`Csexo_usuario` AS `Csexo_usuario` from `usuario` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-01-15 16:08:42
